...
`;
        ...
        const res1 = await axios.post("http://localhost:5000/api/openai/chat", {
          prompt: prompt1,
        });
...
`;
        ...
        const res2 = await axios.post("http://localhost:5000/api/openai/chat", {
          prompt: prompt2,
        });
  ...
  const handleGenerateKeyFeatures = async (tool) => {
    ...
    try {
      ...
      const handleChatSubmit = async () => {
        ...
        try {
          const res = await axios.post(
            "http://localhost:5000/api/openai/chat",
            {
              prompt: chatInput,
            }
          );
      ...
      await axios.put(`http://localhost:5000/api/tools/${tool._id}`, {
